...
Version  : 1.2.2
Release  : 18
URL      : https://www.x.org/releases/individual/lib/libXres-1.2.2.tar.gz
Source0  : https://www.x.org/releases/individual/lib/libXres-1.2.2.tar.gz
Source1  : https://www.x.org/releases/individual/lib/libXres-1.2.2.tar.gz.sig
...
cd %{_builddir}/libXres-1.2.2
pushd ..
cp -a libXres-1.2.2 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670224108
...
cp %{_builddir}/libXres-%{version}/COPYING %{buildroot}/usr/share/package-licenses/libXres/b307e9607ffa7ab6dc4ab7c019d0e62a627b9532
pushd ../build32/
%make_install32
